namespace VibeSuperTonic.Shared;
...
///
/// LINKED INTO THE LAUNCHER — see VibeSuperTonic.Launcher.csproj. One file,
/// compiled into both assemblies, so the engine's idea of "which languages
/// exist" can't drift from the Control Panel's or the registrar's.
/// </summary>
internal sealed record SupertonicLanguage(string Code, string HexLcid, string DisplayName);
